    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/95 backdrop-blur-xl">
      ...
      <AnimatePresence>
        <motion.div 
          ...
          className="relative w-full max-w-xl bg-[#121212] border border-white/5 rounded-[2.5rem] p-6 md:p-8 shadow-2xl overflow-hidden"
        ...
        >
          ...
          <div className="relative space-y-6">
            ...
            <div className="text-center space-y-3">
              <div className="inline-flex p-4 rounded-3xl bg-primary/10 text-primary border border-primary/10 mb-2">
            ...
            <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-3 px-4 flex items-center justify-between text-xs">
              <span className="text-neutral-500">Conta conectada:</span>
              <span className="font-mono text-neutral-300 truncate max-w-[200px]" title={userEmail}>
                {userEmail}
              </span>
            </div>
            ...
            {errorVisible && (
              <motion.div 
                ...
                className="p-4 bg-red-500/10 border border-red-500/20 text-red-400 text-xs sm:text-sm rounded-2xl flex items-start gap-3"
              >
                <AlertTriangle className="w-5 h-5 text-red-500 shrink-0 mt-0.5" />
                <span className="leading-relaxed">{errorVisible}</span>
              </motion.div>
            )}
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-start gap-4 p-4 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] border border-white/5 transition-all cursor-pointer group select-none">
                <div className="relative flex items-center shrink-0 mt-0.5">
                  ...
                  <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all ${
                    acceptTerms 
                      ? 'bg-primary border-primary text-backgroundScale shadow-[0_0_10px_rgba(0,200,83,0.3)]' 
                      : 'border-white/20 group-hover:border-primary/50'
                  }`}>
                    {acceptTerms && <Check className="w-4 h-4 stroke-[3px] text-background" />}
                  </div>
                </div>
                <div className="space-y-1">
                  <span className="text-sm font-medium text-neutral-200">
                    ...
                    <button
                      ...
                      className="text-primary hover:underline underline-offset-4 focus:outline-none inline-flex items-center gap-1 font-semibold"
                    >
                      Termos de Uso
              ...
              <label className="flex items-start gap-4 p-4 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] border border-white/5 transition-all cursor-pointer group select-none">
                <div className="relative flex items-center shrink-0 mt-0.5">
                  ...
                  <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all ${
                    ...
                    {acceptPrivacy && <Check className="w-4 h-4 stroke-[3px] text-background" />}
                  </div>
                </div>
                <div className="space-y-1">
                  <span className="text-sm font-medium text-neutral-200">
            ...
            <button
              ...
              className="w-full bg-primary text-background font-bold py-4.5 rounded-2xl flex items-center justify-center gap-2 active:scale-95 transition-all text-sm shadow-[0_0_20px_rgba(0,200,83,0.15)] disabled:opacity-30 disabled:cursor-not-allowed disabled:pointer-events-none"
        ...
        {showTermsDetail && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/95 backdrop-blur-md">
            <motion.div 
              ...
              className="w-full max-w-2xl bg-[#121212] border border-white/5 rounded-[2rem] shadow-2xl flex flex-col max-h-[85vh]"
              id="details-terms-modal"
            >
              <div className="p-6 border-b border-white/5 flex items-center gap-3">
                <Scale className="w-6 h-6 text-primary" />
                <div>
                  <h3 className="font-bold text-white text-lg">Termos de Uso</h3>
                  <p className="text-xs text-neutral-400">Capitae Finance • Última atualização: Maio de 2026</p>
                </div>
              </div>

              <div className="p-6 overflow-y-auto space-y-6 text-sm text-neutral-300 leading-relaxed font-sans">
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-base">1. Aceite dos Termos</h4>
                  <p>
                ...
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-base">2. Uso do Serviço</h4>
                  <p>
                ...
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-base">3. Assinatura e Pagamentos (Plano PRO)</h4>
                  <p>
                ...
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-base">4. Cancelamento e Reembolso</h4>
                  <p>
                ...
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-base">5. Limitação de Responsabilidade</h4>
                  <p>
              ...
              <div className="p-6 border-t border-white/5 flex gap-3">
                <button
                  ...
                  className="flex-1 bg-primary text-background font-bold py-3.5 rounded-xl text-center text-sm hover:bg-primary/90 transition-colors"
                >
                  Entendi e Aceito
                </button>
                <button
                  ...
                  className="px-6 bg-white/[0.05] hover:bg-white/[0.10] text-white font-semibold py-3.5 rounded-xl text-sm transition-colors"
                >
                  Fechar
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/95 backdrop-blur-md">
            ...
            >
              <div className="p-6 border-b border-white/5 flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white text-lg">Política de Privacidade</h3>
                  <p className="text-xs text-neutral-400">Capitae Finance • Conformidade LGPD</p>
                </div>
              </div>

              <div className="p-6 overflow-y-auto space-y-6 text-sm text-neutral-300 leading-relaxed font-sans">
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-base">1. Introdução à Privacidade</h4>
                  <p>
                ...
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-base">2. Coleta de Informações</h4>
                  <p>
                ...
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-base">3. Direitos sob a LGPD (Lei nº 13.709/2018)</h4>
                  <p>
                ...
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-base">4. Armazenamento e Segurança</h4>
                  <p>
